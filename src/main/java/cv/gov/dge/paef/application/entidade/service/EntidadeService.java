...
public class EntidadeService {
    ...
    public EntidadeInfoDTO updateByNif(Long nif, EntidadeUpdateDTO dto) {
        ...
        return EntidadeInfoDTO.builder()
                ...
                .dataConstituicao(ent.getDtConstituicao() == null ? "" : ent.getDtConstituicao().format(DateTimeFormatter.ISO_LOCAL_DATE))
                .natureza(ent.getDmNatureza() == null ? "" : ent.getDmNatureza()) // se tiver resolver, troca
                .representanteLegal(ent.getRepresentanteLegal() == null ? "" : ent.getRepresentanteLegal())
                .ilha(geoAfter.ilha())
                .concelhoId(geoAfter.concelho())
                .freguesiaId(geoAfter.freguesia())
